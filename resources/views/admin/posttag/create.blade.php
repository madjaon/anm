...
@section('title', 'Thêm post tag')

@section('content')

<div class="row margin-bottom">
	<div class="col-xs-12">
		<a href="{{ route('admin.posttag.index') }}" class="btn btn-success btn-sm">Danh sách post tag</a>
	</div>
</div>
...
<div class="row">
	<div class="col-xs-12">
		<div class="box">
			<form action="{{ route('admin.posttag.store') }}" method="POST">
				{!! csrf_field() !!}
				<div class="box-header">
					<h3 class="box-title">Thêm post tag</h3>
				</div>
				<div class="box-body">
