<div class="menubox animated zoomInDownNew">
  <div class="list-group">
    ...
    <a href="{!! url('hang-phim') !!}" class="list-group-item list-group-item-action" title="Danh sách hãng phim"><i class="fa fa-user-circle-o mr-2" aria-hidden="true"></i>Danh sách hãng phim</a>
